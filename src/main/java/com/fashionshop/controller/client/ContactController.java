...
public class ContactController {
    ...
    public String submitContact(@ModelAttribute("contact") Contact contact, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Cáº£m Æ¡n báº¡n Ä‘Ã£ liÃªn há»‡! ChÃºng tÃ´i sáº½ pháº£n há»“i trong thá»\ufffdi gian sá»›m nháº¥t.");
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("error", "Ä\ufffdÃ£ xáº£y ra lá»—i, vui lÃ²ng thá»­ láº¡i sau.");
        }
